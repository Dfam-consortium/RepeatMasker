...
##---------------------------------------------------------------------------##
##  File:
##      @(#) createRepeatLandscape_echarts.pl
##  Author:
##      Robert M. Hubley   rhubley@systemsbiology.org
##      Juan Caballero     jcaballero@systemsbiology.org
##      Wenchao Lin        linwenchao@yeah.net
##  Description:
##      Based on earlier work by Juan Caballero and Robert M. Hubley,
##      replace the graphic rendering engine with Echarts.
##
#******************************************************************************
...
# ChangeLog
#
#     $Log: createRepeatLandscape_echarts.pl,v $
#     Revision 1.11  July 2, 2019
...
=head1 SYNOPSIS
  ...
  createRepeatLandscape_echarts.pl [-version] -div *.divsum [-t "graph title"]
...
=head1 EXAMPLES
  ...
  Older ( pre 4.0.4 ) RepeatMasker dataset:
     ...
     createRepeatLandscape_echarts.pl -div example.divsum > 
...
<html>
  <head>
   ...
   <h1>Interspersed Repeat Landscape</h1>
   <h3>Figure 1. Interspersed Repeat Landscape</h3>
    <div id="chart_div"  style="width: 600px; height: 400px"></div>
   <h3>Figure 2. Genome Fraction </h3>
   <div id="pie_chart_div" style="width: 600px; height: 400px"></div>

      <div class="clearfix"></div>
   <p>&#169; Tianjin Biochip Corp.</p>
   </div>
_HTML_HEADER_
      ;
}
...
print <<_HEADER_
   <script type="text/javascript">
    ...
    option = {
          ...
          tooltip: {},
          dataset: {
            dimensions: ['number', 'DNA', 'LTR', 'LINE'],
...
print <<_BAR_
        ...
        xAxis: {
          type: 'category',
          name: 'Kimura substitution level (CpG adjusted)',
          nameLocation:'middle',
          nameGap:30,
          nameTextStyle:{
            fontWeight : 'bold',
...
//pieChart
    ...
    var myChart2 = echarts.init(document.getElementById('pie_chart_div'));
    option2 = {
      legend: {
        show:false
      },
